...
/*$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('#branch-offices-grid', {
		data: $(this).serialize()
	});
	return false;
});*/
	...
	<div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone form__article mib-table">
        <div class="mdl-card mdl-shadow--2dp">
            <div class="mdl-card__title mib-table--title">
                <h1 class="mdl-card__title-text table">Sucursales</h1>
                <div>
                	<a href="<?= Yii::app()->baseUrl; ?>/branchoffices/create" class="mdl-button mdl-js-button mdl-js-ripple-effect color-text--orange">Agregar sucursal</a>
                </div>
            </div>
            <div class="mdl-card__supporting-text no-padding">
            	<?php $this->widget('zii.widgets.grid.CGridView', array(
					'id'=>'branch-offices-grid',
					'summaryText' => '',
						...
						array(
							...
							'buttons'=>array(
								'update' => array(
									...
									'imageUrl'=>false,
									'url'=>'Yii::app()->createUrl("branchoffices/update/$data->idbranch_offices")',
								...
								'erase' => array(
									...
									'imageUrl'=>false,
									'url'=>'Yii::app()->createUrl("branchoffices/delete/$data->idbranch_offices")',
									'options'=>array(
										'title'=>'Eliminar',
										'onclick'=>'deleteItem(this, "branch-offices-grid")',
									),
