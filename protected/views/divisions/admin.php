...
<div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--6-col-phone form__article mib-table">
    <div class="mdl-card mdl-shadow--2dp">
        <div class="mdl-card__title mib-table--title">
            <h1 class="mdl-card__title-text table">División</h1>
            <div>
            	<a href="#" class="mdl-button mdl-js-button mdl-js-ripple-effect color-text--orange button-division">Agregar división</a>
            </div>
        </div>
					...
					array(
						...
						'buttons'=>array(
							'erase' => array(
								...
								'imageUrl'=>false,
								'url'=>'Yii::app()->createUrl("divisions/delete/$data->iddivision")',
								'options'=>array(
									'title'=>'Eliminar',
