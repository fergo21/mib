<header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
        ...
        <div class="avatar-dropdown" id="icon">
            ...
            <span class="material-icons mib-profile-letter"><?= Yii::app()->user->name[0]; ?></span>
        </div>
        <!-- Account dropdawn-->
        <ul class="mdl-menu mdl-list mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-shadow--2dp account-dropdown"
            ...
            <li class="mdl-list__item mdl-list__item--two-line">
                <span class="mdl-list__item-primary-content">
                    <span class="material-icons mib-profile-letter"><?= Yii::app()->user->name[0]; ?></span>
                    <span><?= Yii::app()->user->name; ?></span>
                    <span class="mdl-list__item-sub-title"><?= Yii::app()->user->getRoles()->type; ?></span>
                </span>
            </li>
            ...
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/salir">
                <li class="mdl-menu__item mdl-list__item">
                    <span class="mdl-list__item-primary-content">
